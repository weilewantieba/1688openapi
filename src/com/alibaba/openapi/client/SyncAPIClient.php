...
use Keyi1688\com\alibaba\openapi\client\serialize\SerializerProvider;
use Keyi1688\com\alibaba\openapi\client\util\DateUtil;
use Keyi1688\com\alibaba\openapi\client\util\SignatureUtil;
...
class SyncAPIClient
{
     ...
     */
    public function __construct($mix, $appSecret = null)
    {
        if (is_string($mix)) {
